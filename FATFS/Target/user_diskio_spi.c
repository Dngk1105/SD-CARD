...
/*
 * Hàm callback cua HAL_SPI
 * Chi duoc goi khi mot transaction DMA hoan tat
 ...
 * Ham nay polling chu khong dung dma
 * LY DO:
 * Chi phi setup dma so voi truyen 1 byte thong thuong kha lon
 * Ham nay phuc vu gui lenh & cho phan hoi ngay
 * polling se dam bao call -> done -> return
 */
static
BYTE xchg_spi (
